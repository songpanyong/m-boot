...
//					@Spec(params = "requester", path = "requester", spec = Like.class),
					...
					@Spec(params = "reqTimeBegin", path = "requestTime", spec = DateAfterInclusive.class, config = DateUtil.fullDatePattern),
					@Spec(params = "reqTimeEnd", path = "requestTime", spec = DateBeforeInclusive.class, config = DateUtil.fullDatePattern),}) 
