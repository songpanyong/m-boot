...
@Data
@Entity
@Table(name = "T_GAM_PORTFOLIO_ILLIQUID_HOLD_PART_ESTIMATE")
@NoArgsConstructor
@AllArgsConstructor
public class PortfolioIlliquidPartEstimateEntity implements Serializable {

	private static final long serialVersionUID = 3364362813779143013L;
	...
	private PortfolioIlliquidEstimateEntity holdEstimate;
