 ...
 * @date 2017年2月21日 - 下午5:11:05
 */
@Data
@Entity
@Table(name = "T_GAM_PORTFOLIO_LIQUID_HOLD_PART_ESTIMATE")
@NoArgsConstructor
@AllArgsConstructor
public class PortfolioLiquidPartEstimateEntity implements Serializable {

	private static final long serialVersionUID = 8550241331961615786L;

	@Id
	private String oid;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "partOid", referencedColumnName = "oid")
	private PortfolioLiquidHoldPartEntity holdPart;
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "holdEstimateOid", referencedColumnName = "oid")
	private PortfolioLiquidEstimateEntity holdEstimate;
