...
@RestController
@RequestMapping(value = "/mimosa/boot/investor/bankorder/apply", produces = "application/json")
public class InvestorDepositApplyBootController extends BaseController {
	...
	public ResponseEntity<BaseResp> depositApply(@RequestBody @Valid ApplyReq req) {
		...
		BaseResp rep = this.investorDepositApplyService.depositApply4SPV(req, uid);
