...
@NoArgsConstructor
public class TradeOrderQueryJZRep  extends BaseResp  {

	public static final String TRADEORDER_viewStatus_accepted = "accepted";	// 已受理
	public static final String TRADEORDER_viewStatus_work = "work";			// 今日起息
	public static final String TRADEORDER_viewStatus_holding = "holding";	// 持有中
	public static final String TRADEORDER_viewStatus_over = "over";			// 已结束
	public static final String TRADEORDER_viewStatus_fail = "fail";			// 订单失败
	/**
	 * 订单UUID
	 */
