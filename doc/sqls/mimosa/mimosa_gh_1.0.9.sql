...
('10','DoPlatformCheck','平台余额对账手动执行','switch','','enable','no',NULL,NULL,'pass','2017-02-15 20:50:14','2017-02-15 20:58:15'),
('11','PlatformCheckLock','平台余额对账锁定用户','switch','','disable','no',NULL,NULL,'pass','2017-02-15 20:50:14','2017-02-15 20:58:15');
...
(
   ...
   buzzOrderType        varchar(20),
   userType             varchar(20),
   buzzUserType         varchar(20),
   tradeAmount          decimal(22,2),
   fee                  decimal(20,2),
   voucher              decimal(20,2),
   orderStatus          varchar(20),
   buzzOrderStatus      varchar(20),
   orderTime            datetime,
...
(
   ...
   outerOrderCode       varchar(20),
   outerOrderType       varchar(20),
   buzzOrderType        varchar(20),
   buzzUserType         varchar(20),
   outerInvestorOid     varchar(32),
   tradeAmount          decimal(20,2),
   outerFee             decimal(20,2),
   outerVoucher         decimal(20,2),
   outerOrderStatus     varchar(20),
   buzzOrderStatus      varchar(20),
   outerOrderTime       varchar(20),
   outerCheckStatus     detetime,
   dealStatus           varchar(20),
   outerUserType        varchar(20),
   updateTime           timestamp not null default CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
   createTime           timestamp default CURRENT_TIMESTAMP,
   primary key (oid)
);
...
/*==============================================================*/
/* Table: T_MONEY_DIVIDEND_ORDERS_MD                            */
/*==============================================================*/
create table T_MONEY_DIVIDEND_ORDERS_MD
(
   orderOid             varchar(32),
   investorOid          varchar(32),
   publisherOid         varchar(32),
   dividendOffsetOid    varchar(32),
...
(
   ...
   fee                  decimal(20,2),
   orderAmount          decimal(20,2),
   usedCoupons          varchar(32) comment '是否使用卡券 yes:使用 no:未使用',
...
(
   ...
   coupons              varchar(300),
   couponType           varchar(32),
   additionalInterestRate decimal(20,2),
   dAdditionalInterestRate decimal(20,16),
   affectiveDays        int,
   updateTime           timestamp not null default CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
   createTime           timestamp not null default CURRENT_TIMESTAMP,
   primary key (oid)
...
/*==============================================================*/
/* Table: T_MONEY_ORDERS                                        */
/*==============================================================*/
create table T_MONEY_ORDERS
(
   checkOid             varchar(32),
...
/*==============================================================*/
/* Index: T_MONEY_PAY_LOG_orderCode                             */
/*==============================================================*/
create index T_MONEY_PAY_LOG_orderCode on T_MONEY_PAY_LOG
(
   orderCode
);
...
/* Index: cid_ckey                                              */
/*==============================================================*/
create index cid_ckey on T_MONEY_PLATFORM_CHANNEL
(
   cid,
   ckey
);
...
/*==============================================================*/
/* Table: T_MONEY_PLATFORM_DIVIDEND_OFFSET                      */
/*==============================================================*/
create table T_MONEY_PLATFORM_DIVIDEND_OFFSET
(
   oid                  varchar(32) not null,
   productOid           varchar(32),
   dividendDate         date,
   dividendAmount       decimal(20,2),
   toCloseDividendNumber int,
   message              varchar(1000),
   dividendCloseStatus  varchar(100),
   updateTime           timestamp not null default CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
   createTime           timestamp default CURRENT_TIMESTAMP,
   primary key (oid)
);
...
(
   ...
   gaStatus             varchar(20),
   checkDataSyncStatus  varchar(20),
   ldataStatus          varchar(20),
   totalCount           int,
   wrongCount           int,
   wrongLeftCount       int,
   beginTime            datetime,
...
(
   ...
   totalCoupon          int,
   totalCouponAmount    decimal(20,2),
   totalTasteCoupon     int,
   totalTasteCouponAmount decimal(20,2),
   totalRateCoupon      int,
   confirmDate          date,
   updateTime           timestamp not null default CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
   createTime           timestamp not null default CURRENT_TIMESTAMP,
...
(
   ...
   activeInvestorAmount int,
   totalCoupon          int,
   totalCouponAmountsss decimal(20,2),
   totalTasteCoupon     int,
   totalTasteCouponAmount decimal(20,2),
   totalRateCoupon      int,
   confirmDate          date,
...
(
   ...
   additionalInterestRate decimal(20,8),
   affectiveDays        int,
...
/*==============================================================*/
/* Table: T_MONEY_SMS_NOTIFY                                    */
/*==============================================================*/
create table T_MONEY_SMS_NOTIFY
(
   oid                  varchar(32) not null,
   smsSendTypes         varchar(32) comment 'yimei:亿美 ronglian:容联',
   notifyContent        text,
   notifyStatus         varchar(32) comment 'toConfirm:待确认，confirmed:已确认',
   errorCode            int,
   errorMessage         text,
...
/*==============================================================*/
/* Index: IDX_SMS_NOTIFY_statusANDcodeANDnotifyTimes            */
/*==============================================================*/
create index IDX_SMS_NOTIFY_statusANDcodeANDnotifyTimes on T_MONEY_SMS_NOTIFY
(
   notifyStatus,
   errorCode,
   notifyTimes
